...
# 输出应类似于下面这样（包括引号）：Albert Einstein once said,“A person who never made a mistake never tried anything new.”
...
word="时间像海绵里的水，只要你愿意挤，总还是有的。"
famous_person="鲁迅"
message=famous_person+"曾经说过 \""+word+"\""
print(message)